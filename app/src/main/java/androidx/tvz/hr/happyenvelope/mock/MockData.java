...
public class MockData {
    ...
    public static List<Salary> salaries = new ArrayList<>(Arrays.asList(
    ...
    public static List<Relationship> relationships = new ArrayList<>(Arrays.asList(
    ...
    public static List<Locale> locales = new ArrayList<>(Arrays.asList(
    ...
    public static List<Season> seasons = new ArrayList<>(Arrays.asList(
            new Season(0, "Peak (Spring/Summer)"),
            new Season(1, "Off-Peak (Autumn/Winter)")
    ));

    public static List<Gift> gifts = new ArrayList<>(Arrays.asList(
    ...
    public static List<Calculation> calculations = new ArrayList<>(Arrays.asList(
       new Calculation(
               0,
